...
dosbox -c "mount D $(pwd)" -c "mount E ${D7305A}" -c "PATH=Z:;e:\tools" -c "SET ISEARCH=e:\LIBS\\" -c "D:" -c "oc simple /T425 > 1.out" -c "exit"
cat 1.OUT
dosbox -c "mount D $(pwd)" -c "mount E ${D7305A}" -c "PATH=Z:;e:\tools" -c "SET ISEARCH=e:\LIBS\\" -c "D:" -c "ilink simple.tco hostio.lib /f occama.lnk /t425 > 2.out" -c "exit"
cat 2.OUT
